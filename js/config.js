...
const CONFIG = {
  ...
  searchAliases: {
    ...
    'pizza-hut': ['pizza', 'pizzahut', 'ph', 'italian', 'pasta', 'pan-pizza', 'thin-crust', 'hand-tossed', 'garlic-bread', 'wings'],
    'la-pinoz': ['lapinoz', 'la-pinoz-pizza', 'pizza', 'italian', 'gourmet-pizza', 'mexican-fiesta', 'paneer-makhani'],
    'dominos': ['dominos-pizza', 'domino', 'pizza', 'italian', 'cheese-burst', 'thin-crust', 'hand-tossed', 'fresh-pan', 'delivery', '30-minutes'],
    'pizza': ['pizza-hut', 'pizzahut', 'la-pinoz', 'lapinoz', 'dominos', 'italian', 'cheese', 'toppings', 'delivery'],
